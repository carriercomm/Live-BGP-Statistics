...
$mysql_table = 'prepends';
$sorting_array = array("id", "nodeid", "parent_nodeid", "state", "date");

// ----------------------------------------------------------------------

$action_title = "All BGP Prepends"; 
...
?>
					...
					<!-- BGP PREPENDS SECTION START -->
                	<div id="main_content">
                      
						<!-- LIST BGP PREPENDS START -->
                        <fieldset>
							...
							<table width="100%" border="0" cellspacing="2" cellpadding="5">
								...
								$SELECT_NODE1 = mysql_query("SELECT * from nodes WHERE Node_id = '".$LISTING['parent_nodeid']."' ", $db);
								$NODE1 = mysql_fetch_array($SELECT_NODE1);
								$SELECT_NODE2 = mysql_query("SELECT * from nodes WHERE Node_id = '".$LISTING['nodeid']."' ", $db);
						...
						<!-- LIST BGP PREPENDS END -->

					</div>    
					<!-- BGP PREPENDS SECTION END --> 
